...
BLOG_AUTHOR = "Jeremy Dawson"  # (translatable)
...
#Ian 2025-02-09
BLOG_TITLE = {"en": "Jeremy's Writings"}
...
BLOG_DESCRIPTION = "Test website for Jeremy"  # (translatable)
...
# Put pdf's in files/files/test.pdf Link will be: xxxxxxx.github.io/files/test.pdf
...
# Ian 2025-02-12 - Want to display the logo instead of a title
...
# Up one level and in output folder. Seperate from source files - Ian 2021-01-18
# OUTPUT_FOLDER = '../output'
# Go back to defualt location
OUTPUT_FOLDER = 'output'
